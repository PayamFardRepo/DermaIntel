...
const COMMUNITY_CATEGORIES: CommunityCategory[] = [
  {
    ...
    communities: [
      {
        name: 'Melanoma Research Foundation Community',
        platform: 'inspire',
        url: 'https://www.inspire.com/groups/melanoma-research-foundation/',
        members: '15,000+',
        description: 'Support for melanoma patients and families',
      },
      {
        name: 'Skin Cancer Support',
        platform: 'healthunlocked',
        url: 'https://healthunlocked.com/skincancer',
        description: 'UK-based skin cancer community',
      },
      {
        name: 'AIM at Melanoma Community',
        platform: 'inspire',
        url: 'https://www.inspire.com/groups/aim-at-melanoma/',
        members: '8,000+',
        description: 'Awareness, education, and support',
      },
    ],
  },
  {
    ...
    communities: [
      ...
      },
      {
        name: 'Eczema Support',
        platform: 'healthunlocked',
        url: 'https://healthunlocked.com/eczema-support',
        description: 'Tips, treatments, and emotional support',
      },
    ],
  },
  {
    ...
    communities: [
      {
        ...
        platform: 'inspire',
        url: 'https://www.inspire.com/groups/talk-psoriasis/',
        members: '40,000+',
      ...
      },
      {
        ...
        platform: 'healthunlocked',
        url: 'https://healthunlocked.com/psoriasis-support',
    ...
    communities: [
      {
        ...
        platform: 'inspire',
        url: 'https://www.inspire.com/groups/lupus-foundation-of-america/',
        members: '50,000+',
  ...
  },
  {
    ...
    communities: [
      {
        name: 'Rosacea Support Group',
        platform: 'inspire',
        url: 'https://www.inspire.com/groups/national-rosacea-society/',
        members: '12,000+',
        description: 'Tips, triggers, and treatment discussions',
      },
      {
        name: 'Acne Support',
        platform: 'healthunlocked',
        url: 'https://healthunlocked.com/acne-support',
        description: 'Teen and adult acne community',
      },
    ],
  },
  {
    ...
    communities: [
      {
        ...
        platform: 'inspire',
        url: 'https://www.inspire.com/groups/vitiligo-support-international/',
        members: '5,000+',
    ...
    communities: [
      {
        ...
        platform: 'inspire',
        url: 'https://www.inspire.com/groups/phoenix-society-for-burn-survivors/',
        members: '8,000+',
    ...
    communities: [
      {
        ...
        platform: 'healthunlocked',
        url: 'https://healthunlocked.com/britishskinfoundation',
        members: '10,000+',
