"""
Combined ISIC 2019 + 2020 Skin Cancer Classifier - CPU Optimized v3

USES ALL DATA (no undersampling):
- All 48,533 benign + 9,924 malignant = 58,457 images
- Heavy augmentation for malignant (3x virtual increase)
- Weighted sampler: ~40% malignant per batch
- Stability fixes from v2 retained

Usage:
    python train_combined_isic_cpu_v3.py --epochs 15
"""
...
def main():
    ...
    parser.add_argument("--output_dir", default="./checkpoints/combined_isic_v3")
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        # Save best (prioritize balanced when sens >= 75%)
        if val_metrics['sensitivity'] >= 75 and balanced > best_balanced:
        ...
        elif val_metrics['sensitivity'] > best_sens and best_balanced == 0:
            best_sens = val_metrics['sensitivity']
            best_path = output_dir / "best_model.pth"
